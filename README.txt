...
2. Gepetto (Puppet)                        http://geppetto-updates.puppetlabs.com/4.x
3. ShellEd (Bash)                          http://sourceforge.net/projects/shelled/files/shelled/update
4. Open in Terminal (contextual console)   http://eclipse-openinterminal.googlecode.com/svn/trunk/site
